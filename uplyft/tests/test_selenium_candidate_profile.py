...
class CandidateProfileFunctionalTests(LiveServerTestCase):
    ...
    def test_candidate_profile_is_loaded_with_existing_active_profile_details(self):
        ...
        self.assertEquals(first_name.get_attribute("value"), test_user_data["candidate"]["profile"]["first_name"])
        last_name = self.browser.find_element_by_name("last_name")
        self.assertEquals(last_name.get_attribute("value"), test_user_data["candidate"]["profile"]["last_name"])
        address_line = self.browser.find_element_by_name("address_line")
        self.assertEquals(address_line.get_attribute("value"),
    ...
    def test_candidate_profile_update_first_name(self):
        ...
        self.assertEquals(first_name_before.get_attribute("value"), test_user_data["candidate"]["profile"]["first_name"])
        ...
        self.assertEquals(first_name_after.get_attribute("value"), test_user_data["candidate"]["new_profile"]["first_name"])

    def test_candidate_profile_update_last_name(self):
        self.go_to_candidate_profile()
        last_name_before = self.browser.find_element_by_name("last_name")
        self.assertEquals(last_name_before.get_attribute("value"), test_user_data["candidate"]["profile"]["last_name"])
        ...
        self.assertEquals(last_name_after.get_attribute("value"), test_user_data["candidate"]["new_profile"]["last_name"])

    def test_candidate_profile_update_email(self):
        self.go_to_candidate_profile()
        email_before = self.browser.find_element_by_name("email")
        self.assertEquals(email_before.get_attribute("value"), test_user_data["candidate"]["profile"]["email"])
        email_before.clear()
        email_before.send_keys(
            test_user_data["candidate"]["new_profile"]["email"])
        submit_button = self.browser.find_element_by_name("submit")
        submit_button.click()
        email_after = self.browser.find_element_by_name("email")
        self.assertEquals(email_after.get_attribute("value"), test_user_data["candidate"]["new_profile"]["email"])

    def test_candidate_profile_update_address(self):
        self.go_to_candidate_profile()
        address_before = self.browser.find_element_by_name("address_line")
        self.assertEquals(address_before.get_attribute("value"), test_user_data["candidate"]["profile"]["address_line"])
        ...
        self.assertEquals(address_after.get_attribute("value"), test_user_data["candidate"]["new_profile"]["address_line"])

    def test_candidate_profile_update_zip_code(self):
        self.go_to_candidate_profile()
        zip_code_before = self.browser.find_element_by_name("zip_code")
        self.assertEquals(zip_code_before.get_attribute("value"), test_user_data["candidate"]["profile"]["zip_code"])
        ...
        self.assertEquals(zip_code_after.get_attribute("value"), test_user_data["candidate"]["new_profile"]["zip_code"])

    def test_candidate_profile_update_state(self):
        self.go_to_candidate_profile()
        state_before = self.browser.find_element_by_name("state")
        self.assertEquals(state_before.get_attribute("value"), test_user_data["candidate"]["profile"]["state"])
        for option in state_before.find_elements_by_tag_name("option"):
            if option.text == test_user_data["candidate"]["new_profile"]["state_display"]:
                option.click()
                break
        submit_button = self.browser.find_element_by_name("submit")
        submit_button.click()
        state_after = self.browser.find_element_by_name("state")
        self.assertEquals(state_after.get_attribute("value"),
    ...
    def test_candidate_profile_update_gender(self):
        ...
        self.assertEquals(gender_before.get_attribute("value"),
        ...
        self.assertEquals(gender_after.get_attribute("value"),
                          test_user_data["candidate"]["new_profile"]["gender"])

    def test_candidate_profile_update_health_conditions(self):
        self.go_to_candidate_profile()
        health_conditions_before = self.browser.find_element_by_name("health_conditions")
        self.assertEquals(health_conditions_before.get_attribute("value"),
        ...
        for option in health_conditions_before.find_elements_by_tag_name("option"):
            if option.text == \
                    test_user_data["candidate"]["new_profile"]["health_conditions_display"]:
                option.click()
                break
        submit_button = self.browser.find_element_by_name("submit")
        submit_button.click()
        health_conditions_after = self.browser.find_element_by_name("health_conditions")
        self.assertEquals(health_conditions_after.get_attribute("value"),
    ...
    def test_candidate_profile_update_veteran_status(self):
        ...
        self.assertEquals(veteran_status_before.get_attribute("value"),
        ...
        self.assertEquals(veteran_status_after.get_attribute("value"),
    ...
    def test_candidate_profile_update_race(self):
        ...
        self.assertEquals(race_before.get_attribute("value"),
        ...
        self.assertEquals(race_after.get_attribute("value"),
    ...
    def test_candidate_profile_update_ethnicity(self):
        ...
        self.assertEquals(ethnicity_before.get_attribute("value"),
        ...
        self.assertEquals(ethnicity_after.get_attribute("value"),
