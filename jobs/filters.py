...
class JobFilter(django_filters.FilterSet):
    business_title = django_filters.CharFilter(lookup_expr="icontains", label="Job Title")
    ...
    posting_date = django_filters.DateFromToRangeFilter(field_name="posting_date", label="Posted (Between)")
